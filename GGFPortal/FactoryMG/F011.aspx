<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="F011.aspx.cs" Inherits="GGFPortal.FactoryMG.F011" %>
            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" Visible="False" >
                        <LocalReport ReportPath="ReportSource\Factory\ReportF010.rdlc" DisplayName="越南工時資料">
                        </LocalReport>
                    </rsweb:ReportViewer>
               </main>
            </div>
