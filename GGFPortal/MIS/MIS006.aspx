<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MIS006.aspx.cs" Inherits="GGFPortal.MIS.MIS006" %>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="768px" Width="1024px" Visible="False" >
                        <LocalReport ReportPath="ReportSource\MIS\ReportMIS006.rdlc" DisplayName="訂單資料">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </div>
            </div>
