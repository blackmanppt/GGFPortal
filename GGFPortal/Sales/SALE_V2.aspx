<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SALE_V2.aspx.cs" Inherits="GGFPortal.Sales.SALE_V2" UICulture="Auto" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="90%">
                        ...
                        <LocalReport ReportPath="ReportSource\ReportSALE_V2.rdlc" EnableExternalImages="true">
                            <DataSources>
