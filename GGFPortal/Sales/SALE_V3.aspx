<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SALE_V3.aspx.cs" Inherits="GGFPortal.Sales.SALE_V3" UICulture="Auto" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="90%">
                        ...
                        <LocalReport ReportPath="ReportSource\ReportSALE_V3.rdlc" EnableExternalImages="true" DisplayName="Sample">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSetSALE_V3" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                </ContentTemplate>
            </asp:UpdatePanel>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="GGFPortal.DataSetSource.SalesTempDSTableAdapters.samc_reqm1TableAdapter">
                <SelectParameters>
