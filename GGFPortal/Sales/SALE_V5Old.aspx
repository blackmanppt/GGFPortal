<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SALE_V5Old.aspx.cs" Inherits="GGFPortal.Sales.SALE_V5Old" UICulture="Auto" %>
...
<td></td>
                ...
                <tr>
                    <th class="auto-style1">
                        <asp:Label ID="款號LB" runat="server" Text="款號："></asp:Label>
                    </th>
                    <td>
        ...
        <div>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="GGFPortal.DataSetSource.SalesTempDSTableAdapters.samc_reqm5TableAdapter">
                <SelectParameters>
                    ...
                    <asp:SessionParameter DefaultValue="%" Name="cus_style_no" SessionField="cus_style_no" Type="String" />
                </SelectParameters>
