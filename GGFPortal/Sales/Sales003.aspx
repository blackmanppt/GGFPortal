<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sales003.aspx.cs" Inherits="GGFPortal.Sales.Sales003" %>
            ...
            <div class="row">
                <div class="col-md-2">
                    <nav class="navbar navbar-default" role="navigation">
                        <h3 class="text-info text-center">訂單資料查詢
                        </h3>
...
<asp:DropDownList ID="YearDDL" runat="server" class="form-control"></asp:DropDownList>
                ...
                <div class="col-md-10">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="768px" Width="1024px" Visible="False" >
                        <LocalReport ReportPath="ReportSource\Sales\ReportSales003V3.rdlc" DisplayName="訂單資料">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </div>
            </div>
