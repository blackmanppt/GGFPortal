<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sales014.aspx.cs" Inherits="GGFPortal.Sales.Sales014" %>
            ...
            <div class="row">
                <div class="col-md-2">
                    <nav class="navbar navbar-default" role="navigation">
                        <h3 class="text-info text-left">訂單工廠樣品單產區表(三旬)</h3>
                ...
                <div class="col-md-10">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="768px" Width="1024px" Visible="False" >
                        <LocalReport ReportPath="ReportSource\Sales\ReportSale014.rdlc" DisplayName="訂單工廠樣品單" EnableExternalImages="True">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </div>
            </div>
