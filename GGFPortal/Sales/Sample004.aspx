<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sample004.aspx.cs" Inherits="GGFPortal.Sales.Sample004" %>
            ...
            <div class="row">
                <div class="col-md-2">
                    <nav class="navbar navbar-default" role="navigation">
                        <h3 class="text-info text-left">樣品室產量月總表
                        </h3>
...
<asp:DropDownList ID="YearDDL" runat="server" class="form-control"></asp:DropDownList>
                ...
                <div class="col-md-10">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="768px" Width="1024px" Visible="False" >
                        <LocalReport ReportPath="ReportSource\ReportSample02_V2.rdlc" DisplayName="樣品室產量月總表">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </div>
            </div>
