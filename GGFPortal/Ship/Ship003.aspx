                    ...
                    <nav class="navbar navbar-default" role="navigation">
                        ...
                        <div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
                            ...
                            <div class="form-group center-block">
                                <h4>出貨日期</h4>
                                <asp:TextBox ID="StarDayTB" runat="server"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="StarDayTB_CalendarExtender" runat="server" BehaviorID="StarDayTB_CalendarExtender" TargetControlID="StarDayTB" Format="yyyy-MM-dd" class="form-control"/>
                                <asp:TextBox ID="EndDayTB" runat="server"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="EndDayTB_CalendarExtender" runat="server" BehaviorID="EndDayTB_CalendarExtender" TargetControlID="EndDayTB"  Format="yyyy-MM-dd" class="form-control" />
                            </div>
                            <div class="form-group center-block">
                                <h4>代工廠</h4>
