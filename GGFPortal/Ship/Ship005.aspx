<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ship005.aspx.cs" Inherits="GGFPortal.Ship.Ship005" %>
            ...
            <div class="row">
                <div class="col-md-2">
                    <nav class="navbar navbar-default" role="navigation">
                        <h3 class="text-info text-left">出口大表-查詢</h3>
                        ...
                        <div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
                            ...
                            <h4>表單人員</h4>
                            <div>
                                <asp:DropDownList ID="UserDDL" runat="server" CssClass="form-control ">
                                    <asp:ListItem>BOSS</asp:ListItem>
                                    <asp:ListItem>設計師</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <h4>日期</h4>
