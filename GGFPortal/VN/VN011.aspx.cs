...
namespace GGFPortal.VN
{
    ...
    public partial class VN011 : System.Web.UI.Page
    {
        ...
        private StringBuilder selectsql()
        {
            ...
            strsql.AppendFormat(" where [工作時間]  between '{0}' and '{1}' ", (!String.IsNullOrEmpty(StartDay.Text)) ? StartDay.Text : "20000101", (!String.IsNullOrEmpty(EndDay.Text)) ? EndDay.Text : "29990101");
